...
BEGIN
    ...
    -- VALIDACI�N: la cita debe ser de ese doctor
    ...
    -- Solo se puede SOLICITAR cancelaci�n si estaba en estos estados
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- cancelar pagos y registrar devolución (si aplica)
        UPDATE dbo.pago
        ...
        -- etiqueta bitácora (fila que generó el trigger)
        UPDATE b
          SET b.politica = CASE
...
BEGIN
    ...
    FROM movs
    WHERE rn = 2;  -- el anterior al m�s reciente
    ...
    BEGIN TRY
      ...
      -- Etiqueta la fila nueva en bit�cora (la que dej� el trigger al �revertir�)
      UPDATE b
